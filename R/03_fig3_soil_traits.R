# Figure 3: rhizosphere soil traits
# Generates the effect-size heatmap and supplementary grouped dot plots.
...
# 1. Paths
root_dir <- path_from_env("FIG3_DATA_DIR", file.path(repo_dir, "data", "fig3"))
out_dir  <- path_from_env("FIG3_OUT_DIR",  file.path(repo_dir, "outputs", "fig3"))
file_in  <- file.path(root_dir, "fig3.csv")
...
supp_pdf      <- file.path(out_dir, "FigS_groupdot_remaining_soil_traits.pdf")
supp_tiff     <- file.path(out_dir, "FigS_groupdot_remaining_soil_traits.tiff")
...
supp_sum_csv    <- file.path(out_dir, "FigS_groupdot_summary_letters.csv")
supp_post_csv   <- file.path(out_dir, "FigS_groupdot_posthoc_details.csv")
supp_method_csv <- file.path(out_dir, "FigS_groupdot_test_methods.csv")
